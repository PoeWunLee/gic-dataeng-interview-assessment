...
from utils.db_utils import insert_df_to_db, init_db_connect, insert_sql_statement_from_df
...
def load_funds(cnxn_str:str,files:Generator, destination_table:str)->None:
    ...
    try:
        ...
        #3. insert compiled df into table
        with init_db_connect(cnxn_str) as cnxn:
            # insert_df_to_db(dfs_staged, cnxn, destination_table)
            insert_sql_statement_from_df(dfs_staged, cnxn, destination_table)
